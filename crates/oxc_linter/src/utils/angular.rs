...
/// Sourced from @mdn/browser-compat-data (matching @angular-eslint)
pub const NATIVE_EVENT_NAMES: [&str; 100] = [
    "abort",
    "afterprint",
    "afterscriptexecute",
    "animationcancel",
...
pub const NATIVE_EVENT_NAMES_EXTENDED: [&str; 99] = [
    "offline",
    "online",
    "orientationchange",
    "pagehide",
    ...
    "wheel",
    // Additional events for backwards compatibility
    "progress",
    "ratechange",
    "reset",
    "resize",
